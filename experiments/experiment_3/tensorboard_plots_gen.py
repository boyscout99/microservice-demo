...
mean_Gt = get_means('timeseries/tensorboard/14days_steps/rnd_sin_load/S1')
...
plt.title('Training with ${S}_{1}$, periodic with random spikes workload')
plt.xlabel('steps')
plt.ylabel('$\mu_{G_{T}}$')
plt.grid()
plt.legend(loc='upper right', fontsize='x-small')
plt.savefig('rnd_sin_train_S1.png')
